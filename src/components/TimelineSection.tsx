...
const timelineData = [
  {
    ...
    description: '“Memimpin tim pengembangan di Stark Industries Digital, menjaga kualitas kode dan performa sistem global.”',
    icon: (
  ...
  },
  {
    ...
    description: '“Membangun infrastruktur skalabel untuk jutaan pengguna. Menghadapi tantangan backend yang sangat masif.”',
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    description: '“Belajar dari para master di akademi teknologi terkemuka. Mengasah kemampuan desain dan dasar logika pemrograman.”',
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
